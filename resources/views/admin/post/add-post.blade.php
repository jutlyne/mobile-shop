                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="post_name" value="{{ old('post_name') }}" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <select name="cat_post_id" id="post-cat" class="form-control">
                                ...
                                @foreach ($cat_posts as $cat_post)
                                    @if (old('cat_post_id') == $cat_post->cat_post_id)
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="post_desc" class="form-control" id="post-desc"
                                rows="10">{{ old('post_desc') }}</textarea>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <textarea name="post_content"
                                class="summernote form-control">{{ old('post_content') }}</textarea>
                        </div>

        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('admin.user.add-user') }}" id="form-cat-post" class="forms-sample">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="email" value="{{old('email')}}" class="form-control" id="email" placeholder="Nhập email (*)">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="phone" value="{{old('phone')}}" class="form-control" id="password"
                        ...
                        <div class="form-group">
                            ...
                            <select name="role" id="role" class="form-control">
                                ...
                                <option selected value="3">Cộng tác</option>
                            </select>
                        </div>
